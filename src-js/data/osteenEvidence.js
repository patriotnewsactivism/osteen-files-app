...
export const osteenEvidence = [{
  ...
  highlights: ["Audio is cut or covered at several moments then resumes later in the clips.", "Driver requests a breath test; officers indicate the PBT is unavailable; arrest follows.", "Footage includes the trip to the hospital, warrant service, restrained blood draw and video upload sequence."],
  ...
  highlights: ["Court describes the defendant as on unsupervised probation and overrules a 47‑7‑37 objection.", "Defense notes inconsistencies in the petition regarding post‑release versus unsupervised status.", "State’s proof ties an alleged Texas ‘felony DUI’ to the claimed probation violation."],
  ...
  highlights: ["Alleges perjury in the blood‑draw warrant affidavit and seeks suppression under Franks v. Delaware and Wong Sun.", "Asserts a coordinated interstate scheme and First/Fourth/Fourteenth Amendment violations.", "Names Osteen, Doraty, McDougle, GPD, UTMB and Mississippi officials as defendants."],
  ...
  highlights: ["Argues that any Texas DUI would be a misdemeanor and thus constitutes only a ‘technical violation’.", "Notes that a second technical revocation is capped at 120 days and requests vacatur and re‑sentencing.", "Cites Knight v. State and multiple circuit precedents addressing technical violations."],
  ...
  highlights: ["Challenges the blood‑draw warrant affidavit as containing knowingly false statements by Officer Osteen.", "Invokes Franks v. Delaware, arguing that perjury in the affidavit requires suppression of the evidence.", "Highlights contradictions between the affidavit’s claims and toxicology results and body‑cam footage."],
  ...
  highlights: ["Includes the Aug. 17, 2023 petition to revoke probation citing a Galveston ‘felony DWI’ charge.", "Bench warrant and revocation order reference differing probation bases, creating inconsistencies.", "Contains Governor Tate Reeves’ rendition request labeling Reardon a ‘fugitive’.", "Appendices provide booking reports showing arrests, charges and detainers in Galveston County."],
